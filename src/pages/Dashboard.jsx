...
//         <div
//           className={`flex-1 w-[100%] min-h-screen ${
//             isDarkMode
...
//                 <input
//                   type="button"
//                   value={"Uploaded Testimonies"}
//                   placeholder="All Testimonies"
//                   className="ml-[-40px] border-none outline-none p-2 bg-transparent"
//                 />
//               </div>
//             ): ""}
...
//                 >
//                   <p className={`font-sans text-[12px] text-center text-white`}>
//                     10
//                   </p>
//                 </div>
//               </div>
...
//               <CiChat1 style={{ fontSize: "20px" }} />
//               <p className="font-sans text-[#fff] text-[13px] mb-2 opacity-[0.8]">
//                 Reviews
//               </p>
//             </div>
