...
function Reviews() {
  ...
  const allChecked =
    Object.keys(checkedItems).length === reviews.length &&
  ...
  const searchedData = React.useMemo(() => {
    const dataToSearch =
      getFilteredData?.length > 0 ? getFilteredData : reviews;
  ...
  return (
    <div
      ...
      }  m-[auto] mt-8 bg-[#171717] rounded-xl`}
    >
      {/* filter modal */}
      <Modal
            ...
            {sortedData
              ...
              .map((item) => (
                ...
                >
                  ...
                  <div className="pl-2 flex items-center">{item.email}</div>
      ...
      <div className="flex justify-between items-center mt-1">
        ...
        >
          ...
          {Math.min(startIndex + itemsPerPage, reviews.length)} of{" "}
          {reviews.length}
        </div>
