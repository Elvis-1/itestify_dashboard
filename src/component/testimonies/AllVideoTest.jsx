        ...
        <div className={`${!isDarkMode ? 'border rounded-xl w-[98%] m-[auto]' : 'border-none'}`}>
            ...
            <div className={`${isDarkMode ? 'w-[100%]' : 'w-[100%]'} h-[510px] m-[auto] bg-[#171717] rounded-xl ${isDarkMode ? "text-white" : "bg-white text-black border-b border-b-slate-200"}`}>
                ...
                <div className='w-[98%] m-[auto] h-[360px]'> 
                    {/* Table Header */}
                    <div className={`w-[100%] h-[50px] text-[11px] m-[auto] bg-[#313131] grid grid-cols-4 ${isDarkMode ? "text-white" : "bg-slate-100 text-black border-b border-b-slate-200"}`}>
                            ...
                            >
                                <div className="flex items-center w-[260px]">
                                    ...
                                    <div className="p-2 flex w-[60px] h-[60px] items-center">
                                        {item.thumbnail ? (
                                            <img src={item.thumbnail} alt="thumbnail" className="max-w-full max-h-full object-contain" />
                                        ) : (
                                ...
                                <div className="flex items-center w-[263px]">
                                    ...
                                    <div className="p-2 flex w-[151px] h-[50px] items-center">
                                        {item.source ? item.source.length > 12 ? `${item.source.slice(0, 12)}...` : item.source : "No source"}
                                    </div>
                                ...
                                <div className="flex items-center w-[216px]">
                                    <div className="p-2 ml-[-5px] flex flex-[2] w-[50px] h-[50px] items-center">
                                        {item.uploaded_by?.full_name ? item.uploaded_by.full_name.slice(0,8) + '...' : item.uploaded_by?.email?.slice(0,11) + '...' || "N/A"}
                                    </div>
                                ...
                                <div className="flex items-center w-[320px]">
                                    ...
                                    <div className={`p-2 flex w-[120px] h-[30px] pl-2 items-center font-semibold ${
                                        item.upload_status === "upload_now" ? "border border-green-500 text-green-700 rounded-xl p-1 pl-3 outline-none" :
                                        ...
                                        {item.upload_status ? item.upload_status.split("_").map((word) => word.charAt(0).toUpperCase() + word.slice(1)).join(" ") : "N/A"}
                                    </div>
                                    <div
                                        onClick={(e) => {
                                            e.stopPropagation();
